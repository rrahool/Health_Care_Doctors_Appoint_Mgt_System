...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <h3 class="center-block">All User Information</h3>
                    ...
                    echo "
                       ...
                       <tbody>
                        <tr>
                            ...
                            <td style='text-align:center;font-size: large'>$record->phone</td>
                            <td style='text-align:center;font-size: large'>$record->address</td>
                    <td style='text-align: center'>
                        <a href='Patient_info/view.php?id=$record->id' class='btn btn-primary' style='border-radius: 20px; margin-right: 3px'><span class='glyphicon glyphicon-eye-open'></span> View</a>
                        <a href='Patient_info/edit.php?id=$record->id' class='btn btn-success' style='border-radius: 20px; margin-right: 3px'><span class='glyphicon glyphicon-pencil'></span> Edit</a>
                        <a href='Patient_info/trash.php?id=$record->id' class='btn btn-warning' style='border-radius: 20px; margin-right: 3px'><span class='glyphicon glyphicon-trash'></span> Trash</a>
                        <a href='Patient_info/delete.php?id=$record->id' onclick='return confirm_delete()' class='btn btn-danger' style='border-radius: 20px; margin-right: 3px'><span class='glyphicon glyphicon-remove'></span> Delete</a>
                    </td>
            ...
            <div style="margin-left: 40px;margin-bottom: 30px;text-align: center">
                <a href="Patient_info/pdf.php" class="btn btn-lg btn-success"><span class="glyphicon glyphicon-list-alt"></span> <span class="glyphicon glyphicon-circle-arrow-down"></span> Download as PDF</a>
                <a href="Patient_info/xl.php" class="btn btn-lg btn-primary"><span class="glyphicon glyphicon-list-alt"></span> <span class="glyphicon glyphicon-circle-arrow-down"></span> Download as Excel</a>
