        ...
        <div class="col-lg-12">
            ...
            <table class="table table-responsive table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center"><?php echo $singleUser->id ?></td>
                    <td class="text-center"><?php echo $singleUser->first_name ?></td>
                    <td class="text-center"><details> <?php echo $singleUser->email ?></details></td>
                    <td class="text-center"><?php echo $singleUser->phone ?></td>
                    <td class="text-center"><?php echo $singleUser->address ?></td>
