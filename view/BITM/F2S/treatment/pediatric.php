...
$allDoctors=$doctors->getAllTypePediatric();
                ...
                <nav class="navbar navbar-inverse">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="../treatment/pediatric.php">Consultation</a></li>
                    ...
                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active">
                                <img style="height: 360px; width: 700px;" src="../../../../resources/images/slideImage/slide1.jpg"
                                     alt="Chania">
                            ...
                            <div class="item">
                                <img style="height: 360px; width: 700px;" src="../../../../resources/images/slideImage/slide2.png" alt="Chania">
                                <div class="carousel-caption">
                            ...
                            <div class="item">
                                <img style="height: 360px; width: 700px;" src="../../../../resources/images/slideImage/slide3.jpg"
                                     alt="Flower">
                                <div class="carousel-caption">
                            ...
                            <div class="item">
                                <img style="height: 360px; width: 700px;"  src="../../../../resources/images/slideImage/slide4.jpg"
                                     alt="Flower">
                                <div class="carousel-caption">
                                </div>
                            </div>
                            <div class="item">
                                <img style="height: 360px; width: 700px;" src="../../../../resources/images/slideImage/slide5.jpg"
                                     alt="Flower">
                                <div class="carousel-caption">
                            ...
                            <div class="item">
                                <img style="height: 360px; width: 700px;" src="../../../../resources/images/slideImage/slide6.jpg"
                                     alt="Flower">
                                <div class="carousel-caption">
                            ...
                            <div class="item">
                                <img style="height: 360px; width: 700px;" src="../../../../resources/images/slideImage/slide7.jpg"
                                     alt="Flower">
                                <div class="carousel-caption">
                            ...
                            <div class="item">
                                <img style="height: 360px; width: 700px;" src="../../../../resources/images/slideImage/slide8.jpg"
                                     alt="Flower">
                                <div class="carousel-caption">
                            ...
                            <div class="item">
                                <img style="height: 360px; width: 700px;" src="../../../../resources/images/slideImage/slide9.jpg"
                                     alt="Flower">
                                <div class="carousel-caption">
                            ...
                            <div class="item">
                                <img style="height: 360px; width: 700px;" src="../../../../resources/images/slideImage/slide10.jpg"
                                     alt="Flower">
                                <div class="carousel-caption">
                            ...
                            <div class="row ">
                                <figure class="img-responsive">
                                    <img class="img-rounded" height="150px;" width="170px;"
                                         src="<?php echo "../Admin/doctorsImages/".$singleDoctor['image']?>"
                                         alt="Image">
                                </figure>
                                <div class="doctorsProfile">
                                    ...
                                    <form action="consultation.php" method="post">
                                        ...
                                        ?>">
                                        <input type="hidden" name="doctorsId" value="<?php echo
                                        $singleDoctor['id'];?>">
