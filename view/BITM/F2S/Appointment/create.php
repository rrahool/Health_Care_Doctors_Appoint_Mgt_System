                ...
                <nav class="navbar navbar-inverse">
                    ...
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="../Appointment/create.php">Appointment</a></li>
                            <li><a href="../Menu_bar/medicine.php">Medicine</a></li>
                            <li><a href="../Menu_bar/service.php">Service</a></li>
                            <li ><a href="../Menu_bar/contact.php">Others</a></li>
                        </ul>
...
<div class="container content" >
    <div class="main" >
        ...
        <div class="formInfo" >
            ...
            <h2 align="center" >Appointment Information Entry</h2>
          <div style="margin-left: 180px">
              ...
              <form method="post" action="store.php"  class="form-horizontal" role="form" align="center">
                  <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="text" name="patientName" id="patientName"  placeholder="Patient Name" required="true" class="form-control"/>
                      </div>
                  </div>
                  <div class="form-group">
                      <label class="control-label col-sm-2" for="doctorsName"> Doctors Name</label>
                      <div class="col-sm-6">
                          <input type="text" name="doctorsName" id="doctorsName"  placeholder="Doctors Name" required="true" class="form-control"/>
                      </div>
                  </div>
                  <div class="form-group">
                      <label class="control-label col-sm-2" for="patientPhone"> Patient Phone</label>
                      <div class="col-sm-6">
                          <input type="text" name="patientPhone" id="patientPhone"  placeholder="Patient Phone" required="true" class="form-control"/>
                      </div>
                  </div>
                  <div class="form-group">
                      <label class="control-label col-sm-2" for="time"> Time</label>
                      <div class="col-sm-6">
                          <input type="time" name="time" id="time"  placeholder="Time" required="true" class="form-control"/>
                      </div>
                  </div>
                  <div class="form-group">
