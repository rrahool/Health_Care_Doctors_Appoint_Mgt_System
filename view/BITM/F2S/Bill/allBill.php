...
<h1 align="center"> Active Bill List </h1>
    ...
    foreach($allData as $row )
    {
        ...
        echo "
              ...
              <tr>
                  ...
                  <td align='center'>
                                       <a href='create.php?bill_id=$row->bill_id'> <button class='btn btn-success'> Create </button></a>
                     ...
                     <a href='trash.php?bill_id=$row->bill_id'> <button class='btn btn-warning'> Trash </button></a>
